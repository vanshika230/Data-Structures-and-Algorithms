...
public class Exit_Point {
  ...
  public static void main(String[] args) throws Exception {
    ...
    while (true) {
      ...
      if (i < 0) {
        i++;  //exit point is one row behind (in 0th row)
        break;
      } else if (j < 0) {
...
Time complexity of this method is O(mxn) where m is the number of rows and n is the number of columns. You can see we may have to traverse a large part of the 2-D array depending upon the combinations of values in the matrix. Therefore, the time complexity is O(mxn). If the array is a square matrix, we may write the time complexity is: O(n2)
